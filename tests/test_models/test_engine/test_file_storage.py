...
class TestFileStorage(unittest.TestCase):
    ...
    def test_get(self):
        """Test that verifies the method obtaining instance db storage"""
        storage = Filestorage()
        ...
        counterfeit_state_id = storage.get(State, 'counterfeit_id')

        self.assertEqual(counterfeit_state_id, None)

    @unittest.skipIf(models.storage_t != 'db', "not testing db storage")
    def test_count(self):
        """Test used to verify an instance of db storage"""
        storage = Filestorage()
        storage.reload()
